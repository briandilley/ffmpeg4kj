...
ext {
    it.'signing.secretKeyRingFile' = project.findProperty('ffmpeg4kj.signing.secretKeyRingFile') ?:
            project.findProperty('signing.secretKeyRingFile')
    it.'signing.password' = project.findProperty('ffmpeg4kj.signing.password') ?:
            project.findProperty('signing.password')
    it.'signing.keyId' = project.findProperty('ffmpeg4kj.signing.keyId') ?:
            project.findProperty('signing.keyId')
    sonatypeUsername = project.findProperty('ffmpeg4kj.sonatype.username') ?:
            project.findProperty('sonatype.username')
    sonatypePassword = project.findProperty('ffmpeg4kj.sonatype.password') ?:
            project.findProperty('sonatype.password')
    sonatypeStagingProfileId = project.findProperty('ffmpeg4kj.sonatype.stagingProfileId') ?:
            project.findProperty('sonatype.stagingProfileId')
    it.'github.token' = project.findProperty('ffmpeg4kj.github.token') ?:
